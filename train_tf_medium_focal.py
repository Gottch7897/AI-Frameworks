"""Entrenamiento TensorFlow: variante media con Focal Loss."""
...
VARIANT = 'tf_medium_focal'


def main() -> None:
    parser = argparse.ArgumentParser(description='Entrena la variante TensorFlow media con Focal Loss.')
