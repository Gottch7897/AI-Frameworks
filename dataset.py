...
Fuente: Cats vs Dogs (Microsoft) — descarga directa, sin cuenta.

Diseñado para reproducibilidad:
- Idempotente: si las carpetas ya tienen las imágenes, no vuelve a descargar ni a reconstruir.
- Determinista: el muestreo usa un seed fijo.
"""
